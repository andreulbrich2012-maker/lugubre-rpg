    ...
    <main>
      <section className="relative overflow-hidden px-4 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="mt-4 max-w-3xl font-display text-5xl text-white md:text-7xl">Lúgubre RPG</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/characters/new"><Button>Criar ficha</Button></Link>
            <Link to="/campaigns"><Button variant="ghost">Ver campanhas</Button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-[1fr_1.2fr]">
          <h2 className="font-display text-4xl text-ember">Um RPG sobre desgaste, escolhas e presságios.</h2>
      ...
      <section className="mx-auto grid max-w-7xl gap-4 px-4 py-14 md:grid-cols-4">
        {[
